        ...
        {tab === "date" ? (
          <>
            <div className="rounded-2xl bg-[linear-gradient(135deg,#ff5a7e22,#4a9eff22)] p-5">
              ...
              <h2 className="mt-2 text-lg font-bold">AI 约会 / 交友模拟器</h2>
          ...
          <>
            <div className="rounded-2xl bg-[linear-gradient(135deg,#4a9eff22,#22c55e22)] p-5">
              <svg viewBox="0 0 24 24" className="h-8 w-8 text-accent-2" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="rounded-2xl border border-line bg-surface p-4 text-sm text-muted">
              <div className="font-medium text-foreground">怎么玩</div>
