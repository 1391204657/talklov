...
const copy = {
  zh: {
    ...
    usersTitle: "用户",
    usersSub: "按昵称、邮箱、handle 或 UUID 搜索；可授予 VIP / Founder / 认证。",
    searchPlaceholder: "搜索昵称 / 邮箱 / handle / uuid",
    search: "搜索",
    loading: "加载中…",
    noUsers: "没有找到用户。",
    noEmail: "无邮箱",
    ...
    deleteConfirm:
      "确认永久删除该用户？账号与资料将清除，且不再出现在发现列表。此操作不可撤销。",
    reportsTitle: "举报工单",
  ...
  en: {
    ...
    usersTitle: "Users",
    usersSub: "Search by name, email, handle, or UUID. Grant VIP / Founder / verified.",
    searchPlaceholder: "Search name / email / handle / uuid",
    search: "Search",
    loading: "Loading…",
    ...
    searchPhoneHint: "Also search phone / city / email",
    chatsTitle: "Chats",
    ...
    deleteConfirm:
      "Permanently delete this user? Auth + profile are removed and they disappear from Discover. This cannot be undone.",
